		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mi proyecto dest",
									"targetURL": "#commiproyectodest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commiproyectodest-display": {
								"semanticObject": "commiproyectodest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.miproyectodest",
									"url": sap.ui.require.toUrl("com/miproyectodest")
								}
							}
						}
					}
